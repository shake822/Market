	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.headImg}">
				<li class="fieldcontain">
					<span id="headImg-label" class="property-label"><g:message code="user.headImg.label" default="Head Img" /></span>
					
						<span class="property-value" aria-labelledby="headImg-label"><g:fieldValue bean="${userInstance}" field="headImg"/></span>
