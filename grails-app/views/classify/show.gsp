...
<html>
	...
	<body>
		<a href="#show-classify" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-classify" class="content scaffold-show" role="main">
			...
			<ol class="property-list classify">
				...
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="classify.code.label" default="Code" /></span>
						...
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${classifyInstance}" field="code"/></span>
			...
			<g:form url="[resource:classifyInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${classifyInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
